...
# Display modern CLI launch header
Write-Host ""
Write-Host "============================================================" -ForegroundColor DarkCyan
Write-Host " W I N D O W S   H E A L I N G   S Y S T E M " -ForegroundColor Cyan -BackgroundColor DarkBlue
Write-Host "============================================================" -ForegroundColor DarkCyan
Write-Host " Initialize. Optimize. Repair." -ForegroundColor Gray
Write-Host ""
Write-Host " [System is launching...]" -ForegroundColor White
Write-Host " [Leave this window open to ensure operations complete]" -ForegroundColor DarkGray
Write-Host ""
