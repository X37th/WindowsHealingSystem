...
# WindowsHealingSystem

[![GitHub Release](https://img.shields.io/github/v/release/Raphire/WindowsHealingSystem?style=for-the-badge&label=Latest%20release)](https://github.com/Raphire/WindowsHealingSystem/releases/latest)
[![Join the Discussion](https://img.shields.io/badge/Join-the%20Discussion-2D9F2D?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Raphire/WindowsHealingSystem/discussions)
[![Static Badge](https://img.shields.io/badge/Documentation-_?style=for-the-badge&logo=bookstack&color=grey)](https://github.com/Raphire/WindowsHealingSystem/wiki/)

 WindowsHealingSystem is a simple, easy to use and lightweight PowerShell script that allows you to quickly declutter and improve your Windows experience. It can remove pre-installed bloatware apps, disable telemetry, remove intrusive interface elements and much more. No need to painstakingly go through all the settings yourself or remove apps one by one. WindowsHealingSystem makes the process quick and easy!

The script also includes many features that system administrators will enjoy. Such as support for Windows Audit mode, the option to make changes to other Windows users and the ability to run the script without requiring user input during runtime. Please refer to our [wiki](https://github.com/Raphire/WindowsHealingSystem/wiki/) for more details.

![WindowsHealingSystem Menu](/Assets/menu.png)
...
> [!Warning]
> Great care went into making sure this script does not unintentionally break any OS functionality, but use at your own risk! If you run into any issues, please report them [here](https://github.com/Raphire/WindowsHealingSystem/issues).
...
3. Wait for the script to automatically download WindowsHealingSystem.
4. Carefully read through and follow the on-screen instructions.

This method supports command-line parameters to customize the behaviour of the script. Please click [here](https://github.com/Raphire/WindowsHealingSystem/wiki/How-To-Use#parameters) for more information.
...
<details>
  ...
  1. [Download the latest version of the script](https://github.com/Raphire/WindowsHealingSystem/releases/latest), and extract the .ZIP file to your desired location.
  2. Navigate to the WindowsHealingSystem folder
...
<details>
  ...
  4. In PowerShell, navigate to the directory where the files were extracted. Example: `cd c:\WindowsHealingSystem`
  5. Now run the script by entering the following command:

  ```PowerShell
  .\WindowsHealingSystem.ps1
  ```
...
Below is an overview of the key features and functionality offered by WindowsHealingSystem. For more information about what features are included in the default mode please refer to [this section](#default-settings) below.

> [!Tip]
> All of the changes made by WindowsHealingSystem can easily be reverted and almost all of the apps can be reinstalled through the Microsoft Store. A full guide on how to revert changes can be found [here](https://github.com/Raphire/WindowsHealingSystem/wiki/Reverting-Changes).

#### App Removal

- Remove a wide variety of preinstalled apps. Click [here](https://github.com/Raphire/WindowsHealingSystem/wiki/App-Removal) for more info.
...
- Option to [apply changes to a different user](https://github.com/Raphire/WindowsHealingSystem/wiki/Advanced-Features#running-as-another-user), instead of the currently logged in user.
- [Sysprep mode](https://github.com/Raphire/WindowsHealingSystem/wiki/Advanced-Features#sysprep-mode) to apply changes to the Windows Default user profile. Afterwards, all new users will have the changes automatically applied to them.

### Default Settings

WindowsHealingSystem offers a default mode that allows you to quickly and easily apply the changes that are recommended for most people. This includes uninstalling apps that most would consider bloatware, removing many annoying distractions and disabling telemetry and tracking. To apply the default settings, launch the script as you normally would and select option `1` in the script menu. Alternatively, you can launch the script with the `-RunDefaults` parameter. Example:
...
WindowsHealingSystem is licensed under the MIT license. See the LICENSE file for more information.
