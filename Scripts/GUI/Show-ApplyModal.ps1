function Show-ApplyModal {
    ...
    if (-not ([System.Management.Automation.PSTypeName]'Windows Healing System.FocusHelper').Type) {
        Add-Type -Namespace WindowsHealingSystem -Name FocusHelper -MemberDefinition @'
        ...
        try {
            ...
            if ($RestartExplorer -and -not $script:CancelRequested) {
                ...
                $applyWindow.Dispatcher.Invoke([action]{
                    ...
                    [WindowsHealingSystem.FocusHelper]::ForceActivate($hwnd)
                })
            }
            ...
            if ($script:CancelRequested) {
                ...
                if ($RestartExplorer) {
                    ...
                    if ($rebootFeatures.Count -gt 0) {
                        ...
                        $script:ApplyCompletionMessageEl.Text = "Your clean system is ready. Thanks for using Windows Healing System!"
                    }
                }
            }
